...
description: 'Expert in latest library versions for ccxt, pydantic, pytest-asyncio, and ta-lib'
model: Claude Sonnet 4.5 (copilot)
argument-hint: 'Ask about specific Grid Bot libraries (e.g., "ccxt async patterns", "pydantic validation", "ta-lib indicators")'
tools: [read/readFile, agent/runSubagent, context7/get-library-docs, context7/resolve-library-id, search/codebase, search/fileSearch, web/fetch, context7/query-docs, context7/resolve-library-id, memory]
handoffs:
