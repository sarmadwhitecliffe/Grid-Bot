---
description: 'Template for invoking TDD agents (Red-Green-Refactor cycle) for Grid Bot implementation'
applies-to: 'All Grid Bot feature and bug fix development'
---

# TDD Workflow Prompt Templates

Use these templates to invoke TDD agents (Red, Green, Refactor) for test-driven development in Grid Bot.
...
## When to Use TDD Cycle

- **New feature implementation** — Start with TDD Red for each new feature
- **Bug fixes** — Write failing test reproducing bug, then fix
- **API changes** — Test-first ensures backwards compatibility
- **Refactoring** — TDD Refactor improves code while keeping tests green
